...
class Img_Prompt_TwoWayTransformer(nn.Module):
    def __init__(
        self,
        depth: int,
        embedding_dim: int,
    ...
    def forward(
        ...
        prompt_img_feature = prompt_img_feature.flatten(2).permute(0, 2, 1)
        
        # Prepare queries
        queries = prompt_img_feature
        keys = image_embedding
